...
public class formTaoDeThi extends javax.swing.JFrame {
    ...
    private ArrayList<CauHoi> cauHoi = new ArrayList<>();
    /**
    ...
    private void initComponents() {
        ...
        btnSetQuizTitle = new javax.swing.JButton();
        ...
        txtTieuDe.setBackground(new java.awt.Color(255, 255, 255));
        txtTieuDe.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        btnSetQuizTitle.setBackground(new java.awt.Color(153, 0, 255));
        btnSetQuizTitle.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnSetQuizTitle.setForeground(new java.awt.Color(255, 255, 255));
        btnSetQuizTitle.setText("OK");
        btnSetQuizTitle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSetQuizTitleActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtTieuDe, javax.swing.GroupLayout.PREFERRED_SIZE, 385, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29)
                .addComponent(btnSetQuizTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnSetQuizTitle, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private boolean validateFields() {
        if(deThi == null) {
            JOptionPane.showMessageDialog(null, "Vui lòng nhập môn thi!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        
        String cauHoi = this.txtCauHoi.getText();
        ...
        if(cauHoi.trim().isEmpty() || A.trim().isEmpty() || B.trim().isEmpty() || C.trim().isEmpty() || D.trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Vui lòng điền đầy đủ câu hỏi và đáp án!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            return false;
        } else {
            if(answer == null) {
                JOptionPane.showMessageDialog(null, "Vui lòng chọn đáp án đúng!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                return false;
            } else {
                return true;
            }
    ...
    private void btnCauTiepTheoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCauTiepTheoActionPerformed
        ...
        if(valid) {
            cauHoi.setA(rbtnA.getText().trim());
            cauHoi.setB(rbtnA.getText().trim());
            cauHoi.setC(rbtnA.getText().trim());
            cauHoi.setD(rbtnA.getText().trim());
            
            String answer = null;
            
            if(rbtnA.isSelected()) {
                answer = rbtnA.getText().trim();
            } else if(rbtnB.isSelected()) {
                answer = rbtnB.getText().trim();
            } else if(rbtnC.isSelected()) {
                answer = rbtnC.getText().trim();
            } else if(rbtnD.isSelected()) {
                answer = rbtnD.getText().trim();
            } 
            
            cauHoi.setDapAn(answer);
            cauHoi.setNoiDung(this.txtCauHoi.getText().trim());
    ...
    private void btnSetQuizTitleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetQuizTitleActionPerformed
        // TODO add your handling code here:
        String tieuDe = txtTieuDe.getText();
        
        if(tieuDe.trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Vui lòng nhập tiêu đề!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
        } else {
            txtTieuDe.setEditable(false);
            this.deThi = new DeThi(tieuDe);
        }
    }//GEN-LAST:event_btnSetQuizTitleActionPerformed
    ...
    private javax.swing.JButton btnSetQuizTitle;
